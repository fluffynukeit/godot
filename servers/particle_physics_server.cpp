...
void ParticlePhysicsServer::_bind_methods() {
	...
	ClassDB::bind_method(D_METHOD("create_cloth_particle_body_model", "trimesh", "stretch_stiffness", "bend_stiffness", "tether_stiffness", "tether_give", "pressure", "allow_tearing"), &ParticlePhysicsServer::create_cloth_particle_body_model);
	...
	BIND_ENUM_CONSTANT(PARTICLE_PRIMITIVE_SHAPE_TYPE_CONVEX);
	BIND_ENUM_CONSTANT(PARTICLE_PRIMITIVE_SHAPE_TYPE_TRIMESH);
