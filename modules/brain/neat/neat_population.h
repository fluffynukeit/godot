...
public:
	enum StatisticKeys {
		STATISTIC_EPOCH,
		STATISTIC_IS_EPOCH_ADVANCED,
		STATISTIC_POP_CHAMPION_FITNESS,
		STATISTIC_POP_CHAMPION_SPECIES_ID,
		STATISTIC_SPECIES_COUNT,
		STATISTIC_SPECIES_YOUNG_COUNT,
		STATISTIC_SPECIES_STAGNANT_COUNT,
		STATISTIC_SPECIES_AVG_AGES,
		STATISTIC_SPECIES_BEST_ID,
		STATISTIC_SPECIES_BEST_AGE,
		STATISTIC_SPECIES_BEST_OFFSPRING_PRE_STEAL,
		STATISTIC_SPECIES_BEST_OFFSPRING,
		STATISTIC_SPECIES_BEST_CHAMPION_OFFSPRING,
		STATISTIC_SPECIES_BEST_IS_DIED,
		STATISTIC_POP_AVG_FITNESS,
		STATISTIC_POP_IS_STAGNANT,
		STATISTIC_POP_EPOCH_LAST_IMPROVEMENT,
		STATISTIC_POP_STOLEN_CRIBS,
		STATISTIC_REPRODUCTION_CHAMPION_MUTATE_WEIGHTS,
		STATISTIC_REPRODUCTION_CHAMPION_ADD_RANDOM_LINK,
		STATISTIC_REPRODUCTION_MATE_MULTIPOINT,
		STATISTIC_REPRODUCTION_MATE_MULTIPOINT_AVG,
		STATISTIC_REPRODUCTION_MATE_SINGLEPOINT,
		STATISTIC_REPRODUCTION_MUTATE_ADD_RANDOM_LINK,
		STATISTIC_REPRODUCTION_MUTATE_ADD_RANDOM_NEURON,
		STATISTIC_REPRODUCTION_MUTATE_WEIGHTS,
		STATISTIC_REPRODUCTION_MUTATE_TOGGLE_LINK_ACTIVATION,
	};
...
private:
	...
	brain::NtEpochStatistics statistics;
...
VARIANT_ENUM_CAST(NeatPopulation::StatisticKeys);
